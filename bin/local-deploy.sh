...
sudo bash -c 'cat bin/assets/nginx.conf > /etc/nginx/sites-available/pwa-personal-main'
sudo ln -s /etc/nginx/sites-available/pwa-personal-main /etc/nginx/sites-enabled/pwa-personal-main 
